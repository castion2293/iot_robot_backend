...
class RobotTotalStatusTransformer implements TransformContract
{
    public function transformCollection($attributes)
    {
        $total_status = $attributes->payload['data'];
        ...
        return collect([
            ...
            'ID' => $attributes->payload['ID'],
            'DATETIME' => $attributes->payload['DATETIME']
        ]);
    }
